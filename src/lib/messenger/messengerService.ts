...
export class MessengerService {
  ...
  private async processDeliveryReceipt(event: Record<string, unknown>, _organizationId: string): Promise<void> {
    try {
  ...
  private async processReadReceipt(event: Record<string, unknown>, _organizationId: string): Promise<void> {
    try {
