...
describe('/api/orders/recent', () => {
  ...
  describe('GET', () => {
    it('should return 401 for unauthorized requests', async () => {
      ...
      const request = new MockNextRequest('http://localhost:3000/api/orders/recent');
    ...
    it('should respect limit parameter', async () => {
      ...
      const request = new MockNextRequest('http://localhost:3000/api/orders/recent?limit=5');
      await GET(request);
